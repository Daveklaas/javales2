...
/*for ( let i = 0 ; i < NOVIEmployees.length ; i++ ) {
    ...
    NOVIEmployees[i] = {firstName : NOVIEmployees[i].firstName, lastName : NOVIEmployees[i].lastName , email : NOVIEmployees[i].firstName + "." + NOVIEmployees[i].lastName + "@novi.nl"}
